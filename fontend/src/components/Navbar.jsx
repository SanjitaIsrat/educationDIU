      ...
      {isAuthenticated && (
        <div className="bg-emerald-600 flex justify-between items-center py-3 px-3 sm:px-12 shadow-input fixed w-full z-50">
          ...
          <div className="flex items-center relative">            
            ...
            <button
              className="text-white text-2xl  ml-4  font-poppins font-light border-border1  rounded-md py-1 px-3 lg:px-2 "
              onClick={() => dispatch(logOut())}
            ><FaUserEdit />
          </button>
            <button
              className="text-white text-2xl  ml-4  font-poppins font-light border-border1  rounded-md py-1 px-3 lg:px-4 "
              onClick={() => dispatch(logOut())}
            >
              <PiSignOutFill />
            </button>
