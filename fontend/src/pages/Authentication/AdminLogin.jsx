...
const AdminLogin = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-screen z-9 backdrop-saturate-200 drop-shadow-lg blur-none bg-inherit">
      <MetaData title={"Admin Login"} />
      <img src={Logo} alt="Logo" className=" w-30 h-32 contrast-125 brightness-125" />
